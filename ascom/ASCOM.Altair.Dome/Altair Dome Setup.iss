...
; Generated by Karamyshev Vladimir on 07.03.2021 (UTC)
;
[Setup]
AppID={{27b4a626-f17f-4a51-a590-012f19b56684}
AppName=ASCOM Altair Dome Dome Driver
AppVerName=ASCOM Altair Dome Dome Driver 6.0.0
AppVersion=6.0.0
AppPublisher=Karamyshev Vladimir <quangorn@gmail.com>
AppPublisherURL=mailto:quangorn@gmail.com
...
OutputDir="."
OutputBaseFilename="Altair Dome Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\Altair Dome"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\Altair Dome"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Altair.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Altair.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Altair.Dome.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.Altair.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.Altair.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
